...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2020 at 03:33 PM
...
(9, '', 'nascamncasc', 'Y', 'Week', 5, 'Severe', '                    '),
(24, '', ',mmmmmmmmmmmmmmmm', 'N', 'Hour', 2147483647, 'Mild', '                    '),
(25, '', ',mmmmmmmmmmmmmmmm', 'N', 'Hour', 2147483647, 'Mild', '                    '),
(26, '', ',mmmmmmmmmmmmmmmm', 'N', 'Hour', 2147483647, 'Mild', '                    '),
(27, '', ',m.,m,.m.,m,', 'Y', 'Month', 1, 'Moderate to Severe', '                    '),
(28, '', ',m.,m,.m.,m,', 'Y', 'Month', 1, 'Moderate to Severe', '                    '),
(29, '', ',m.,m,.m.,m,', 'Y', 'Month', 1, 'Moderate to Severe', '                    '),
(30, '', 'nm,n,mn,mn,mnm,', 'Y', 'Month', 55, 'Mild to Moderate', '                    '),
(31, '', 'dsfjsd', 'N', 'Year', 52, 'Mild to Moderate', '                    '),
(32, '', 'sd', 'N', 'Week', 99, 'Mild', '                    '),
(33, '', 'nascamncasc', '', 'Hour', 55, 'Moderate', '                    '),
(34, '', 'nascamncasc', 'N', 'Hour', 55, 'Mild to Moderate', '                    '),
(35, '', 'nascamncasc', 'N', 'Hour', 55, 'Mild to Moderate', '                    '),
(36, '', 'nascamncasc', 'N', 'Hour', 5, 'Mild to Moderate', '                    '),
(37, '', 'nascamncasc', 'N', 'Hour', 50, 'Mild to Moderate', '                    '),
(38, '', 'nascamncasc', 'N', 'Hour', 9, 'Mild to Moderate', '                    '),
(39, '', 'nascamncasc', 'N', 'Hour', 9, 'Mild to Moderate', '                    '),
(40, '', 'd', 'Y', 'Month', 2, 'Life Threatening Severity', 'kjho                '),
(41, '668872716333', 'd', 'N', 'Year', 1, 'Mild to Moderate', 'lpkop               '),
(42, '', ',mmmmmmmmmmmmmmmm', 'N', 'Hour', 2147483647, 'Mild', '                    '),
(43, '', ',mmmmmmmmmmmmmmmm', 'N', 'Hour', 2147483647, 'Mild', '                    '),
(44, '', ',mmmmmmmmmmmmmmmm', 'N', 'Hour', 2147483647, 'Mild', '                    ');
...
(6, '123', '222222222221', 'Fasting', '2020-03-19', '                                                 ');
...
INSERT INTO `u_eme_info` (`e_id`, `u_id`, `u_name`, `u_phone`, `u_address`, `u_city`, `u_district`, `u_state`, `u_pin`) VALUES
(10, '720599171114', 'darsh', 123, 'dfdsfsdf', 'jetpur', 'rsfjdskfh', 'kjdhfkjsd', 0),
(15, '123', 'Dhruvil dfssdfsdfsd ', 2147483647, 'Jalaram-1, street-3, university road', 'Rajkot', 'hsagdh', 'Gujarat', 0);
...
('123', 'dhruvil', 'Dhruvil13', 'dpjkldj', 'Raithatha', '2020-03-28', 'Male', '17069934727', 'dhruvilr04@gmail.com', 'B Positive', '7069934727', 'jalaram', 'Rajkot', 'jhvjksdhlgjhsdlfgfdsgds', 'Gujarat', '360007'),
...
('720599171114', 'abc123', 'Darsh', 'Rajeshbhai', 'Ambaliya', '1999-10-24', 'Male', '720599171114', 'darshambaliya@gmail.com', 'Do ', '9099520770', 'Harikrishna Kunj, Bapu ni wadi', 'Jetpur', 'Rajkot', 'Gujarat', '360370');
...
(1, '123', 'Alcohol Addiction', 'Yes', '03/21/2020', 'asda', '                                                 ');
...
--
ALTER TABLE `u_allergy`
  MODIFY `allergy_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
...
--
ALTER TABLE `u_bloodpressure`
  MODIFY `bp_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `u_bodytemperature`
  MODIFY `bt_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `u_problem`
  MODIFY `pr_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `u_respiratoryrate`
  MODIFY `rr_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `u_spo2`
--
ALTER TABLE `u_spo2`
  MODIFY `sp_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
